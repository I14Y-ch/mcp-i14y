...
@pytest.mark.asyncio
async def test_get_catalog_themes_uses_core_endpoint():
...
@pytest.mark.asyncio
async def test_get_catalog_themes_fetch_all_uses_core_endpoint():
    with patch("helpers.core_api_client.CoreApiClient.get_all_pages", new_callable=AsyncMock) as mock_get_all:
